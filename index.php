        ...
        <div class="visual">
            <div class="container">
                <div class="visual-catch">
                    <h2 class="visual-title js-fadeInDefault">インターネットで<br />世界から、未来に繋ぐ。</h2>
                    <p class="visual-sub js-fadeInDefault2">革新的な未来を創造する、イノベーションを提供します。</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="about">
            <div class="container">
                ...
                <div class="container-right">
                    <div class="about-item js-fadeIn">
                        <h3 class="about-sub"><span>次世代の技術を提供</span></h3>
                        <p class="about-text">弊社はWebデザイン・制作・運用を通じて、お客様のビジネスの成長を支援しています。</p>
                        <p class="about-text">
                            高い品質と美しさを追求し、使いやすく親しみやすいWebサイトを提供することで、お客様のビジネスをより魅力的にし、成果を最大化することが私たちの使命です。</p>
    ...
    <section class="section" id="service">
        <div class="service">
            <div class="container">
                ...
                <div class="container-right">
                    <div class="service-item js-fadeIn">
